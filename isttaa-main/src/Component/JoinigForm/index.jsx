        ...
        <div className='contact-main'>
            ...
            <div style={service == "institute" && {background:"rgba(59, 125, 237, 0.05)"} || service == "solutions" &&  {background:"rgba(43, 162, 76, 0.05)"} || service == "shop" && {background:"rgba(228, 62, 43, 0.05)"} || {}} className='contact-form'>
                <div className='contact-form-box'>
                    <Form onFinish={handleSubmit} form={form} layout='vertical' style={{ width: "100%" }}>
                        <Row gutter={40}>
                        ...
                        <div span={24} className='form-button'>
                            <button type='submit' style={service == "institute" && {background:"#3B7DED"} || service == "solutions" &&  {background:"#2BA24C"} || service == "shop" && {background:"#E43E2B"} || {}} >Submit Now</button>
                        </div>
                    </Form>
                </div>
            </div>
